...
public class RaceResultsService {
    ...
    // System.out.println("SERVICE: Calling repository.findByRaceName() with
    // parameter: " + racename);

    // List<RaceResults> results = raceResultsRepository.findByRaceName(racename);

    // System.out.println("SERVICE: Repository returned " + results.size() + "
    // results");
    ...
    // System.out.println("SERVICE: Returning " + results.size() + " results to
    // controller");
    // return results;
    // }
    ...
    public List<RaceResultsWithStravaDTO> getRaceResults(String racename) {
        List<Object[]> rawResults = raceResultsRepository.findByRaceNameRaw(racename);
        return rawResults.stream()
                .map(obj -> new RaceResultsWithStravaDTO(
                        (String) obj[0],
                        (String) obj[1],
                        (String) obj[2],
                        (String) obj[3]))
