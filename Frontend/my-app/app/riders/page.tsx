  ...
  return (
    <div className="h-full p-8 overflow-auto">
      ...
      <div className="mb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {riders.map((rider) => (
            <Card key={rider.riderId} className="h-48 hover:shadow-lg transition-shadow">
              <CardHeader>
              ...
              <CardContent className="flex-1 mt-2 flex flex-col justify-end">
      ...
      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
        <h2 className="text-xl font-semibold mb-4">Search for More Riders</h2>
        <p className="text-gray-600 mb-4">
          Find any professional cyclist and view their race results, Strava profiles, and more.
        </p>
